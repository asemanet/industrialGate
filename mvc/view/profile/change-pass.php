...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <form method="post" name="form-change-pass"  action="/profile/changePass" class="form-horizontal form-label-left col-md-8 col-xs-6">
        <div class="item form-group">
              <label class="control-label col-md-3 col-sm-2 col-xs-12 text-muted h5" for="old-pass">رمز عبور فعلی <span
                          class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control col-md-5 col-xs-12"  type="password" required="required"  placeholder="" name="old-pass">
              </div>
          </div>
        <div class="item form-group">
                <label class="control-label col-md-3 col-sm-2 col-xs-12 text-muted h5 " for="password"><?=_ph_password?> <span
                            class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="item form-group">
                <label class="control-label col-md-3 col-sm-2 col-xs-12 text-muted h5" for="confirm_password"><?=_ph_confirm_password?> <span
                            class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
