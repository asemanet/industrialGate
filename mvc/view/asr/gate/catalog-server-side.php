...
<div class="page-title">
    <div class="title_left">
        <h5><small> گزارش برگه خروج پیشرفته</small></h5>
    </div>
...
<div class="col-md-12">
<table   id="catalog-user-permit"  data-order='[[ 5, "desc" ]]' class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%"  >
    <thead>
    <tr>
        <th>نام مشترک</th>
        <th>شماره قرارداد</th>
    ...
    $("document").ready(function () {
        ...
        function fetch_data(is_date_search, start_date='', end_date='') {
            ...
            var tableCatalogUserPermit = $('#catalog-user-permit').DataTable({
                ...
                "orderCellsTop": true,
                "ajax": {
                    "url": "<?=baseUrl()?>/asr/catalogServerSide",
                    "type": "POST",
                    data:{
                ...
                "columns": [
                    ...
                    {data: "due_date", className: "aseman-ltr", "width": "%"},
                    {data: "car_type"},
